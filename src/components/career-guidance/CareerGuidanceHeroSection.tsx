...
const PATHWAYS: PathwayCard[] = [
  {
    id: "highschool",
    icon: <IconCompass className="w-5 h-5 text-brand-300" />,
  ...
  {
    id: "university",
    icon: <IconGraduationCap className="w-5 h-5 text-sky-300" />,
  ...
  {
    id: "graduate",
    icon: <IconBriefcase className="w-5 h-5 text-indigo-300" />,
  ...
  {
    id: "career_changer",
    icon: <IconTarget className="w-5 h-5 text-accent-red-300" />,
...
export function CareerGuidanceHeroSection() {
  return (
    <div className="relative overflow-hidden rounded-[16px] border border-brand-800/40 bg-gradient-to-br from-[#002a66] via-[#004098] to-[#0a1931] p-6 sm:p-8 text-white shadow-soft transition-all duration-300 hover:shadow-lift">
      {/* Background ambient glow */}
      <div className="pointer-events-none absolute -right-20 -top-20 h-80 w-80 rounded-full bg-brand-400/20 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-20 -left-20 h-80 w-80 rounded-full bg-accent-red-500/10 blur-3xl" />

      <div className="relative z-10">
        {/* Top Badges */}
        <div className="flex flex-wrap items-center gap-2 sm:gap-3">
          <span className="inline-flex items-center gap-1.5 rounded-full bg-white/10 px-3 py-1 text-xs font-bold text-white backdrop-blur-sm border border-white/20">
            <HcmuteBrandMark className="h-3.5 w-3.5 text-accent-red-400" />
            <span>HCMUTE AI CAREER INTELLIGENCE v6.0</span>
          </span>
          <span className="rounded-full bg-emerald-500/20 px-3 py-1 text-xs font-semibold text-emerald-300 border border-emerald-400/30">
            ✓ Chuẩn khoa học & Miễn phí toàn diện
          </span>
        ...
        <div className="mt-4 grid gap-6 lg:grid-cols-12 lg:items-center">
          <div className="lg:col-span-8">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black tracking-tight text-white leading-tight">
              Trợ Lý AI Tư Vấn Hướng Nghiệp & Ra Quyết Định Nghề Nghiệp HCMUTE
            </h2>
            <p className="mt-3 text-sm sm:text-base text-slate-200 leading-relaxed max-w-3xl">
              Không chỉ là bài kiểm tra tính cách đơn thuần, đây là <strong>hệ thống trợ giúp ra quyết định nghề nghiệp</strong> kết hợp thuật toán so khớp tất định đa chiều, phân tích mức độ phơi nhiễm AI, tính điểm chuẩn trúng tuyển và đồng hành cùng <strong>AI Career Coach</strong> cá nhân hóa.
            </p>
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <Link
                ...
                scroll={false}
                className="inline-flex items-center justify-center gap-2 rounded-[10px] bg-brand-500 px-5 py-2.5 text-sm font-bold text-white shadow-xs transition-all hover:bg-brand-600 hover:scale-[1.02] active:scale-[0.98]"
              >
                <IconCompass className="h-4 w-4" />
                <span>Làm trắc nghiệm Career DNA (5 phút)</span>
              </Link>

              <Link
                href="/ai-tools/career-guidance?tab=coach"
                scroll={false}
                className="inline-flex items-center justify-center gap-2 rounded-[10px] border border-white/20 bg-white/10 px-4 py-2.5 text-sm font-semibold text-white backdrop-blur-sm transition-all hover:bg-white/20"
              >
                <IconBot className="h-4 w-4 text-brand-300" />
                <span>Trò chuyện với AI Coach</span>
              </Link>

              <Link
                href="/ai-tools/career-guidance?tab=career_explorer"
                scroll={false}
              ...
              >
                <span>Khám phá 80+ Nghề nghiệp</span>
          ...
          <div className="lg:col-span-4">
            <div className="grid grid-cols-2 gap-2.5 rounded-[14px] border border-white/10 bg-white/5 p-3.5 sm:p-4 backdrop-blur-md">
              <div className="rounded-[10px] bg-white/5 p-3 border border-white/5">
              ...
              <div className="rounded-[10px] bg-white/5 p-3 border border-white/5">
                <div className="text-xl sm:text-2xl font-black text-sky-300">60+</div>
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {PATHWAYS.map((p) => (
              <Link
                ...
                scroll={false}
                className="group relative flex flex-col justify-between rounded-[12px] border border-white/10 bg-white/5 p-4 transition-all duration-200 hover:-translate-y-1 hover:border-brand-400/50 hover:bg-white/10 hover:shadow-lg"
              >
                <div>
                  <div className="flex items-center justify-between">
                    <span className="p-2 rounded-[8px] bg-white/10">{p.icon}</span>
